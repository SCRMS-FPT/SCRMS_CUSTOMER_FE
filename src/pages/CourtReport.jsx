...
import SidebarLayout from "../components/GeneralComponents/SidebarLayout";
import CourtStatistics from "../components/CourtComponents/CourtStatistics";
// import Bookings from "../components/Bookings";
import ManageCourts from "../components/CourtComponents/ManageCourts";
...
const CourtReport = () => {
  ...
  const renderContent = () => {
    switch (selectedTab) {
      ...
      case "bookings":
        return (
          <h1 className="text-xl font-semibold">Bookings (Coming Soon)</h1>
        );
      case "availability":
        return (
      ...
      case "promotions":
        return (
          <h1 className="text-xl font-semibold">Promotions & Discounts</h1>
        );
      case "customers":
        return (
          <h1 className="text-xl font-semibold">Customer List & Insights</h1>
        );
      case "notifications":
