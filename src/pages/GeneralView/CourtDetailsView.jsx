...
const CourtDetails = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (
        foundCourt &&
        foundCourt.durations &&
        foundCourt.durations.length > 0
      ) {
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700">
                        ...
                        <span className="font-medium">
                          {court.availableHours.start} -{" "}
                          {court.availableHours.end}
                        </span>
                      </span>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {facilities.map((facility, index) => (
                      ...
                      >
                        ...
                        ></div>
                        <span
                          className={facility.available ? "font-medium" : ""}
                        >
                          {facility.name}
                        </span>
                      </div>
                  ...
                  <div className="prose text-gray-700">
                    <ul>
                      ...
                      <li>
                        Surface type: {court.surfaceType || "All weather"}
                      </li>
                      <li>
                        Indoor/Outdoor: {court.isIndoor ? "Indoor" : "Outdoor"}
                      </li>
                    </ul>
                  </div>
                </motion.div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-6">
              ...
              <div className="mt-5 pt-4 border-t border-gray-200">
                ...
                <div className="text-sm text-gray-500">
                  This venue is typically booked {court.popularTimes || "7"}{" "}
                  times per day
                </div>
              </div>
            </div>
