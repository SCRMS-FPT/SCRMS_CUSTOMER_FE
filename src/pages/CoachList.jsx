...
import SearchCoachList from "../components/SearchCoachList";
...
const CoachList = () => {
    ...
    useEffect(() => {
        ...
        console.log("📋 Filtered Coaches:", filteredCoaches.length, "coaches available");
    }, [selectedSport, selectedLocation, selectedFee, searchTerm, filteredCoaches]);
                ...
                <div className="col-span-8">
                    <div className="bg-white p-6 rounded-lg">
                        {paginatedCoaches.length > 0 ? (
                            paginatedCoaches.map((coach) => <CoachCard key={coach.id} coach={coach} />)
                        ) : (
