      ...
      case 1:
        return (
          <Box sx={{ mt: 4, display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <Paper elevation={3} sx={{ p: 3, mb: 3, mt: 2, maxWidth: 280, width: "100%" }}>
            ...
            <Box sx={{ mb: 2, width: "100%", textAlign: "center" }}>
              ...
              <Typography variant="body2" gutterBottom>
                Số tiền: <strong>{parseFloat(amount).toLocaleString()} VND</strong>
              </Typography>
              <Typography variant="body2" gutterBottom>
            ...
            {depositSuccess ? (
              <>
                ...
                <Typography variant="body1" gutterBottom align="center">
                  Số tiền <strong>{parseFloat(amount).toLocaleString()} VND</strong> đã được thêm vào ví của bạn.
                </Typography>
