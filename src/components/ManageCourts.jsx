    ...
    return (
        <div>
            {selectedCourt ? (
                ...
                <div className="p-4">
                    <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Manage Courts</h1>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        ...
                        <Card className="shadow-lg">
                            <Statistic
                                ...
                                value={bookedSchedule.filter((booking) => booking.date >= new Date().toISOString().split("T")[0]).length}
                    ...
                    <Table
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                key: "status",
                                render: (status) => (
                                    <Tag color={status === "available" ? "blue" : "red"}>{status}</Tag>
                                ),
                            },
                            {
                                title: "Actions",
                                ...
                                render: (_, record) => (
                                    <Space>
                                        <Button icon={<EyeOutlined />} onClick={() => handleViewCourt(record)}>
                                            View
                                        </Button>
                                    </Space>
                                ),
