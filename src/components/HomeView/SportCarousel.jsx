...
const SportsCarousel = () => {
  ...
  // Mapping for URL redirection: if sport name doesn't match the URL, convert it accordingly.
  const sportMapping = {
  ...
  const handleClick = (sportName) => {
    const sportType = sportMapping[sportName] || sportName;
    navigate(`/courts/sport/${encodeURIComponent(sportType)}`);
  };
        ...
        {sportsData.map((sport, index) => (
          ...
          >
            <div className="relative overflow-hidden rounded-lg shadow-lg">
              ...
              <div className="absolute bottom-0 left-0 right-0 h-16 flex items-center justify-center bg-black/50 group-hover:bg-white/70 transition-all duration-300">
