...
const BookingPagination = ({ currentPage, totalPages, onPageChange, pageSize, onPageSizeChange, totalItems }) => {
    const pageSizeOptions = [4, 9, 12, 15]
    ...
    return (
        <div className="flex flex-col md:flex-row justify-between items-center mt-8 text-sm w-full">
            <div className="mb-4 md:mb-0 text-slate-600">
                ...
                {Math.min(currentPage * pageSize, totalItems)} trên {totalItems} lịch đặt
            </div>
