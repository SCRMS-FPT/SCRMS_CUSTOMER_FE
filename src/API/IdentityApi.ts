...
protected processGetUserDashboard(response: Response): Promise<UserDashboardDto> {
   ...
   * @return OK
   */
  loginWithGoogle(token: LoginWithGoogleRequest): Promise<void> {
   ...
   * @return OK
   */
  registerWithGoogle(token: RegisterWithGoogleRequest): Promise<void> {
  ...
  updateProfile(request: UpdateProfileRequest | undefined): Promise<void> {
    ...
    if (request) {
      ...
      if (
        request.selfIntroduction !== undefined &&
        request.selfIntroduction !== null
      )
   ...
   * @return OK
   */
  resetPasswordConfirm(body: ResetPasswordConfirmRequest): Promise<void> {
    let url_ = this.baseUrl + "/api/identity/users/reset-password-confirm";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processResetPasswordConfirm(_response);
    });
  }

  protected processResetPasswordConfirm(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  verify(token: string): Promise<void> {
    let url_ = this.baseUrl + "/api/identity/verify-email?token={token}";
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.proccessVerify(_response);
    });
  }

  protected proccessVerify(response: Response): Promise<any> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
...
export class LoginWithGoogleRequest implements ILoginWithGoogleRequest {
  token: string | undefined;

  constructor(data?: ILoginWithGoogleRequest) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property))
          (<any>this)[property] = (<any>data)[property];
  ...
  static fromJS(data: any): LoginWithGoogleRequest {
    data = typeof data === "object" ? data : {};
    let result = new LoginWithGoogleRequest();
    result.init(data);
    return result;
  }
...
export class RegisterWithGoogleRequest implements IRegisterWithGoogleRequest {
  ...
  constructor(data?: RegisterWithGoogleRequest) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property))
          (<any>this)[property] = (<any>data)[property];
  ...
  static fromJS(data: any): RegisterWithGoogleRequest {
    data = typeof data === "object" ? data : {};
    let result = new RegisterWithGoogleRequest();
    result.init(data);
    return result;
  }
...
export interface IRegisterWithGoogleRequest {
  token: string | undefined;
  birthDate?: Date;
  phone?: string | undefined;
  gender?: string | undefined;
...
export class UpdateProfileRequest implements IUpdateProfileRequest {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["newImageFiles"])) {
        ...
        for (let item of _data["newImageFiles"]) this.newImageFiles!.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.newImageFiles)) {
      data["newImageFiles"] = [];
      for (let item of this.newImageFiles) data["newImageFiles"].push(item);
    }
    ...
    if (Array.isArray(this.imagesToDelete)) {
      data["imagesToDelete"] = [];
      for (let item of this.imagesToDelete) data["imagesToDelete"].push(item);
    }
    return data;
  }
}
